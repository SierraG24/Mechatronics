...
// Enables the clock and access to the specified GPIO port.
...
// Disables the clock for the specified GPIO port to save power.
...
// Configures a pin as a digital output with push-pull drive mode.
...
// Configures a pin as a digital output with open-drain drive mode.
...
// Configures a pin as a digital input by setting it as input and enabling the digital function.
...
// Configures a pin for analog input by enabling analog mode and disabling digital functions.
...
// Unlocks and commits changes to protected GPIO pins (like PF0).
...
// Assigns an alternate peripheral function (like UART, PWM, or I2C) to the specified pin.
